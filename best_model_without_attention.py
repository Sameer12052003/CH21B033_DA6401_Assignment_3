...
output_folder = "predictions_vanilla"
os.makedirs(output_folder, exist_ok=True)
timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
output_path = os.path.join(output_folder, f"predictions_{timestamp}.txt")
...
wandb.init(project="DA6401_Assignment_3",entity="ch21b033-iit-madras", name="Vanilla_Test_Accuracy")
...
wandb.log({"Sample Predictions Grid": table})
wandb.finish()